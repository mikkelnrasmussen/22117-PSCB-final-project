...
/home/ctools/naccess-2.1.1/naccess AF-P12931-with-cofactors.pdb

# Run FoldX in repair mode:
/home/ctools/foldx-5.2023/foldx --command=RepairPDB --pdb=AF-P12931-with-cofactors.pdb --ionStrength=0.05 --pH=7 --vdwDesign=2 --out-pdb=1 --pdbHydrogens=false  | tee foldx.log
...
/home/ctools/foldx-5.2023/foldx --command=BuildModel --pdb=AF-P12931-with-cofactors_Repair.pdb --mutant-file=individual_list.txt --ionStrength=0.05 --pH=7 --vdwDesign=2 --out-pdb=1 --pdbHydrogens=false --numberOfRuns=5
